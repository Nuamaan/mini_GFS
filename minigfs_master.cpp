...
{
  std::cout<<"SFelixWu receiving ObtainChunkURL" << std::endl;
  Json::Value result;
...
{
  std::cout << "SFelixWu receiving PushChunk2Replica" << std::endl;
  Json::Value result;
  result["status"] = "GFSERR_STALE";
  return result;
}
...
{
  std::cout << "SFelixWu receiving CommitAbort" << std::endl;
  Json::Value result;
  result["status"] = "GFSERR_STALE";
  return result;
}
...
{
  Directory GFS_root
  { "http://127.0.0.1:8384", "1234567890", "Directory", "00000000", "root", "00000002" };
