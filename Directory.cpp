...
bool Dirent::Jdump(Json::Value *input_json_ptr)
{
...
Directory::Directory(std::string core_arg_host_url, std::string core_arg_owner_vsID,
...
Json::Value
Directory::ObtainChunkURL(std::string arg_name, std::string arg_fhandle, std::string arg_chunk_index)
{
  Json::Value result;
...
Json::Value
Directory::LookUp(std::string arg_dir_fhandle, std::string arg_name)
{
  int i;
  int flag = 0;
  Json::Value result;
...
Json::Value
Directory::Create(std::string arg_dir_fhandle, std::string arg_name, std::string arg_sattr)
{
  int i;
  Json::Value result;
...
bool Directory::Jdump(Json::Value *input_json_ptr)
{
  if ((input_json_ptr == NULL) ||
      ((*input_json_ptr).isNull() == true) ||
      ((*input_json_ptr).isObject() != true))
